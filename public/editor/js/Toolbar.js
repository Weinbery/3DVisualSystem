...
var Toolbar = function ( editor ) {
	...
	var translate = new UI.Button( '转换' );
	...
	signals.transformModeChanged.add( function ( mode ) {
		...
		switch ( mode ) {
			...
			case '转换': translate.dom.classList.add( 'selected' ); break;
			case '旋转': rotate.dom.classList.add( 'selected' ); break;
			case '缩放': scale.dom.classList.add( 'selected' ); break;
	...
	var snap = new UI.THREE.Boolean( false, '快照' ).onChange( update );
	buttons.add( snap );
