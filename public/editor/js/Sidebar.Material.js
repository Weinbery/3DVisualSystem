...
Sidebar.Material = function ( editor ) {
	...
	materialProgramRow.add( new UI.Text( '程序' ).setWidth( '90px' ) );
	...
	materialMapRow.add( new UI.Text( '映射' ).setWidth( '90px' ) );
	...
	materialAlphaMapRow.add( new UI.Text( 'Alpha 映射' ).setWidth( '90px' ) );
	...
	materialBumpMapRow.add( new UI.Text( '碰撞映射' ).setWidth( '90px' ) );
	...
	materialNormalMapRow.add( new UI.Text( '常规映射' ).setWidth( '90px' ) );
	...
	materialDisplacementMapRow.add( new UI.Text( '位移图' ).setWidth( '90px' ) );
	...
	materialRoughnessMapRow.add( new UI.Text( '粗略图' ).setWidth( '90px' ) );
	...
	materialMetalnessMapRow.add( new UI.Text( '金属贴图' ).setWidth( '90px' ) );
	...
	materialSpecularMapRow.add( new UI.Text( '高亮贴图' ).setWidth( '90px' ) );
	...
	materialLightMapRow.add( new UI.Text( '光照图' ).setWidth( '90px' ) );
	...
	materialAOMapRow.add( new UI.Text( 'AO贴图' ).setWidth( '90px' ) );
	...
	materialEmissiveMapRow.add( new UI.Text( '发光贴图' ).setWidth( '90px' ) );
	...
	materialShadingRow.add( new UI.Text( '平面阴影' ).setWidth( '90px' ) );
	...
	materialOpacityRow.add( new UI.Text( '模糊图' ).setWidth( '90px' ) );
	...
	materialAlphaTestRow.add( new UI.Text( 'Alpha测试' ).setWidth( '90px' ) );
